...
public class JobRepository implements JobDAO {
    ...
    public List<Job> findAllStarted() {
        ...
        HibernateUtil.withinSession(() -> {
            Query<Job> jobQuery = HibernateUtil.getSession().createQuery("from Job j where j.startDate is not null and j.endDate is null order by j.startDate desc", Job.class);
    ...
    public List<Job> findHistoryByClient(Client client) {
        ...
        HibernateUtil.withinSession(() -> {
            Query<Job> jobQuery = HibernateUtil.getSession().createQuery("from Job j where j.client = :client and j.endDate is not null order by j.endDate desc", Job.class);
    ...
    public List<Job> findHistoryByVehicle(Vehicle vehicle) {
        ...
        HibernateUtil.withinSession(() -> {
            Query<Job> jobQuery = HibernateUtil.getSession().createQuery("from Job j where j.vehicle = :vehicle and j.endDate is not null order by j.endDate desc", Job.class);
    ...
    public List<Job> findHistoryByVinNumber(String vinNumber) {
        ...
        HibernateUtil.withinSession(() -> {
            Query<Job> jobQuery = HibernateUtil.getSession().createQuery("from Job j where j.vehicle.vinNumber = :vinNumber and j.endDate is not null order by j.endDate desc", Job.class);
    ...
    public List<Job> findNotStartedByFixedDate(Date date) {
        ...
        HibernateUtil.withinSession(() -> {
            Query<Job> jobQuery = HibernateUtil.getSession().createQuery("from Job j where j.fixedDate = :date and j.startDate is null and j.endDate is null order by j.id desc", Job.class);
    ...
    public List<Date> findNotStartedFixedDates() {
        ...
        HibernateUtil.withinSession(() -> {
            Query jobQuery = HibernateUtil.getSession().createQuery("select distinct j.fixedDate from Job j where j.endDate is null and j.startDate is null order by j.fixedDate asc");
